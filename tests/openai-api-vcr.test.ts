...
import { canRunVcrSuite, withCassette } from "./helpers/cassettes";
...
describeVcr("ai& API VCR coverage", () => {
  it("lists models", async () => {
    await withCassette("list-models", async () => {
  ...
  it("creates a chat completion", async () => {
    await withCassette("chat-completion", async () => {
      const client = new OpenaiApi(configuration());
  ...
  it("creates a legacy completion", async () => {
    await withCassette("completion", async () => {
      const client = new OpenaiApi(configuration());
  ...
  it("creates a response", async () => {
    await withCassette("response", async () => {
      const client = new OpenaiApi(configuration());
  ...
  it("covers the file lifecycle", async () => {
    await withCassette("files-lifecycle", async () => {
  ...
  it("covers completing a chunked upload", async () => {
    await withCassette("uploads-complete", async () => {
  ...
  it("covers cancelling a chunked upload", async () => {
    await withCassette("uploads-cancel", async () => {
      const uploads = new UploadsApi(configuration());
